...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'removebg ?(.*)', fromMe: true, desc: Lang.REMOVEBG_DESC}, (async (message, match) => {    
        ...
        await message.client.sendMessage(message.jid,fs.readFileSync('Godzilla.png'), MessageType.document, {filename: 'Godzilla.png', mimetype: Mimetype.png});
        await load.delete();
    }));
}
    ...
    Asena.addCommand({pattern: 'removebg ?(.*)', fromMe: false, desc: Lang.REMOVEBG_DESC}, (async (message, match) => {    
        ...
        await pipeline(
		    rbg,
		    fs.createWriteStream('Godzilla.png')
        );
