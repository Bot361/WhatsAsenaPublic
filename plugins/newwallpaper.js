...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'newwallpaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'newwallpaper', fromMe: false, desc: Lang.WP}, (async (message, match) => {
