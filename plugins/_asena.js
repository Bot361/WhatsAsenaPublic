...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'godhelp ?(!*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'● *Godzilla Private By Punsith* \n *Support by LUCIFER K®* ●\n\n' + CMD_HELP, MessageType.text
            );    
        } else {
    ...
    Asena.addCommand({pattern: 'godhelp ?(!*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'● *Godzilla Public By Punsith*\n *Support by LUCIFER K®* ●\n\n' + CMD_HELP, MessageType.text
            );    
        } else {
