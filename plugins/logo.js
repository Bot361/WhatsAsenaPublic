...
if (Config.WORKTYPE == 'private') {
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Copyright © 2021 | Godzilla By Punsith & LUCIFER K®'})
...
Asena.addCommand({pattern: 'fancy ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {

    if (match[1] === '') return await message.client.sendMessage(message.jid,NEED_WORD);

    var webimage = await axios.get(`https://docs-jojo.herokuapp.com/api/fancy?text=${match[1]}`, { responseType: 'arraybuffer' })

    await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Copyright © 2021 | Godzilla By Punsith & LUCIFER K®'})

    }));

    Asena.addCommand({pattern: 'screed?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {

    if (match[1] === '') return await message.client.sendMessage(message.jid,NEED_WORD);

    var webimage = await axios.get(`https://docs-jojo.herokuapp.com/api/screed?text=${match[1]}`, { responseType:  arraybuffer  })
...
if (match[1] === '') return await message.client.sendMessage(message.jid,NEED_WORD);
    ...
    var webimage = await axios.get(`https://docs-jojo.herokuapp.com/api/thunder?text=${match[1]}`, { responseType:  arraybuffer  })
